...
@section('judul','Upload Perintah Kerja')
    ...
    <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-body">
            ...
            <form role="form" class="form-horizontal form-groups-bordered" action="<?php echo url() ;?>/perintahkerja/<?php echo $transaksi[0]->no_agenda ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label">File Perintah Kerja</label>

                    <div class="col-sm-5">
                        <input type="file" name="fileperintahkerja" class="form-control file2 inline btn btn-primary" multiple="1" data-label="<i class='glyphicon glyphicon-circle-arrow-up'></i> &nbsp;Pilih File" required/>
                    </div>
                </div>
